...
st.markdown("Module URLs:")
for module in [9,10,11,12,13]:  # Replace with your actual module numbers
    st.markdown(f"- Module {module}: https://overridedashboard.streamlit.app/?module={module}")
